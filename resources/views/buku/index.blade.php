    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <!-- Tombol Tambah Buku -->
                <a href="{{ route('master.data.buku.create') }}" class="btn btn-primary" role="button">Tambah Buku</a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($bukus as $buku)
                        <tr>
                            ...
                            <td>
                                @if ($buku->cover)
                                    <img src="{{ asset('storage/' . $buku->cover) }}" alt="Cover Buku" width="50" height="75">
                                @else
